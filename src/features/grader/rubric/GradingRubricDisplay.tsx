...
import { SubmissionCommentForm } from "./SubmissionCommentForm.js";
import type {
  CanvasSubmission,
...
export const GradingRubricDisplay: FC<{
  ...
  // State for general comment - REMOVED (now handled by separate component)
  ...
  return (
    <section className="px-1 pb-1 bg-slate-950 rounded flex flex-col justify-between flex-1 w-full">
      ...
      <div className="space-y-4 flex-1 overflow-auto bg-violet-950/15 rounded w-full">
